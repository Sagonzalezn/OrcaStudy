...
export const Navbar =() => {
  return (
  <nav class="bg-primary dark:bg-gray-900 fixed w-full z-20 top-0 start-0">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-6 bg-primary">
  <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="1 white no letters.svg" class="h-8" alt="OrcaStudyLogo"/>
      <span class="self-center text-xl font-roboto
      font-semibold whitespace-nowrap text-white">OrcaStudy</span>
  </a>
  <div class=" flex md:order-2 space-x-3 md:space-x-3 rtl:space-x-reverse justify-end bg-primary font-roboto">
