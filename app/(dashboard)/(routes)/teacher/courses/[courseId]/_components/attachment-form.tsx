          ...
          {initialData.attachments.length > 0 && (
            <div className="space-y-2">
              {initialData.attachments.map((attachment) => (
                <div
                  key={attachment.id}
                  className="flex items-center p-3 w-full bg-sky-100 border-sky-200 border text-sky-700 rounded-md mt-5"
                >
      ...
      {isEditing && (
        <div>
          ...
          <div className="text-xs text-muted-foreground mt-4">
            Añade lo que necesiten tus estudiantes para pasar el curso.
          </div>
        </div>
      )}
    </div>
